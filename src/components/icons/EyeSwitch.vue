...
<template>
  <span @click="toggle" class="cursor-pointer">
    <svg v-if="modelValue" class="w-4 h-4 text-a-l-default dark:text-a-d-d10" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <svg v-else class="w-4 h-4 text-t-l-d10 dark:text-b-d-l22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
